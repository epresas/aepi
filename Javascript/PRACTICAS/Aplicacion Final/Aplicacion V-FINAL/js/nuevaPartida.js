...
if (opener === null) {
    ...
    alert("Por favor, accede al panel desde el tablero principal");
...
document.onkeyup = function(e){
    ...
    if (e.keyCode === 27) {
        ...
        let cerrar = confirm("¿Deseas cerrar la ventana? Se perderán los cambios");
...
document.getElementById("campoNombre").onkeyup = function(e){
